    ...
    <div className="bottommargin">
        <div className="container">
            <div className="section">
                <div className="row">
                    ...
                    The following are some client websites actually online, with some yet to be online. A mobile app too, not deployed to the store yet (community app). Also listed are some personal sites.
                    </blockquote>
                    </div>
                </div>
            </div>
        ...
        <Carousel options={{ fullWidth: true, indicators: true }}>
            <div className='amber white-text center'>
                ...
                <p><img className="responsive-img" src="assets/images/palsbook.png" alt="palsbook" /></p>
            </div>
            <div className='amber white-text center'>
            ...
            <div className='amber white-text center'>
                <h2>BDF Connect</h2>
                <p className="black-text">An app for the Benin Dns Forum community.</p>
                <p><img className="responsive-img" src="assets/images/bdfconnect.png" alt="bdfconnect" /></p>
            </div>
            <div className='amber white-text center'>
                <h2>MitZiks.Com</h2>
